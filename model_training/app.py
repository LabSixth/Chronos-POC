...
def load_prediction_data():
    ...
    """
    prophet_predictions = pd.read_csv("Model_Artifacts/prophet_preds.csv")
    chronos_predictions = pd.read_csv("Model_Artifacts/chronos_preds.csv")
...
def get_visualization_paths():
    ...
    """
    prophet_path = "Model_Artifacts/Prophet_predicted_vs_real.png"
    chronos_path = "Model_Artifacts/Chronos_predicted_vs_real.png"
